...
keys = [Key(key[0], key[1], *key[2:]) for key in [
    ...
    # QTerminal
    ([mod, "shift"], "Return", lazy.spawn("qterminal")),
    ...
    ([mod, "shift"], "0", lazy.spawn(
        "pactl set-sink-mute @DEFAULT_SINK@ toggle"
    )),

    # Brightness
    ([mod], "0", lazy.spawn("brightnessctl set +10%")),
    ([mod], "o", lazy.spawn("brightnessctl set 10%-")),

    # Bluetooth
    ([mod, "shift"], "b", lazy.spawn("blueman-manager")),
